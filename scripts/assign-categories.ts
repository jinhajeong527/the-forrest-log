...
const MANUAL_OVERRIDES: Record<string, string[]> = {
  ...
  "Nectar Of The Moon Pose Ii": ["SUPINE"],
  "Sage Twist Pose": ["SEATED", "TWISTS"],
  "Revolved Boat Pose Variation Knees Bent": ["ABDOMINALS", "TWISTS"],
  "Shoulder Rolls Bent Elbows Variation Close Up": ["SEATED"],
  "Seated Ear To Shoulder Pose": ["SEATED"],
  "Horse Pose Side Stretch": ["STANDING_POSES"],
  ...
  "Shoulder Rolls Close Up": ["SEATED"],
  "Revolved Pigeon Pose": ["SEATED", "TWISTS"],
  "Revolved Seated Straddle Pose Variation Forward Bend Flow": ["FORWARD_BENDS", "SEATED", "TWISTS"],
  "Horse Pose Side Stretch Hand On Floor": ["STANDING_POSES"],
  ...
  "Horse Pose Flexed Wrists": ["STANDING_POSES"],
  ...
  "Mongoose Pose": ["SEATED"],
  "Standing Side Lunge Pose Forward Bend Cow Face Arms": ["STANDING_POSES"],
  "Brolga Pose": ["BALANCING_POSES", "STANDING_POSES"],
  "Head To Ankle Prep Pose": ["BALANCING_POSES", "FORWARD_BENDS"],
  "Wrist Joint Rotation": ["SEATED", "STANDING_POSES"],
  "Circle Of Joy": ["SEATED"],
  "Eagle Arms Close Up": ["TWISTS"],
  "Revolved High Lunge High Lunge Pose Vapoariation Arms Behind Flow": ["LUNGES", "STANDING_POSES", "TWISTS"],
};
